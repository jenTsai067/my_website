...
function Skill() {
  return (
    <section className="w-full max-w-300 h-full flex flex-col gap-8 justify-center items-center m-auto">
      ...
      <div className="grid px-4 w-full max-w-[1200px] justify-around grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-2 md:gap-y-8 lg:gap-y-0 lg:grid-cols-4 lg:grid-rows-1">
        <SkillCard
